...
// The site's own Adsterra GET CODE values live in this one allowlisted module.
const adIdAllowlistedFiles = new Set(["config/ads.ts"]);
...
function inspect(path) {
  ...
  if (!adIdAllowlistedFiles.has(displayPath)) {
